...
class PluginTemplateFunctionalLifecycleManager(BaseLifecycleManager):
    """Lifecycle manager for PluginTemplateFunctional plugin using new architecture"""
    ...
    def __init__(self, plugins_base_dir: str = None):
        ...
        self.plugin_data = {
            ...
            "description": "A functional component template for creating BrainDrive plugins with React Hooks",
            "version": "2.0.0",
            "type": "frontend",
            ...
            "compatibility": "1.0.0",
            "scope": "PluginTemplateFunctional",  # TODO: Update scope name
            "bundle_method": "webpack",
            "bundle_location": "dist/remoteEntry.js",
            "is_local": False,
            "long_description": "A comprehensive functional component template for creating BrainDrive plugins with React Hooks, TypeScript, and Module Federation. Includes examples of custom hooks, service integration, theme support, and modern React patterns.",
        ...
        self.module_data = [
            {
                "name": "PluginTemplateFunctionalModule",  # Must match webpack.config.js exposes name
                "display_name": "Plugin Template (Functional)",  # TODO: Update display name
                "description": "A functional component template for BrainDrive plugins with React Hooks",  # TODO: Update description
